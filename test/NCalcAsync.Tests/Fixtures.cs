...
namespace NCalcAsync.Tests
{
    ...
    public class Fixtures
    {
        ...
        public void Should_Throw_Exception_On_Lexer_Errors_Issue_6()
        {
            ...
            Assert.AreEqual("token recognition error at: '\"' at 1:1\r\ntoken recognition error at: '\"' at 1:3", result1.Message);
            ...
            Assert.AreEqual("String '' was not recognized as a valid DateTime.\r\ntoken recognition error at: '\"' at 1:8\r\ntoken recognition error at: '{' at 1:9\r\n\r\nmismatched input ':' expecting ')' at 1:11\r\n", result2.Message);
        }
